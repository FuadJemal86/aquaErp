                    ...
                    <FormField
                      ...
                      render={({ field }: { field: any }) => (
                        <FormItem>
                          ...
                          >
                            <FormControl>
                              <SelectTrigger className="h-14 sm:h-12 border-slate-200 focus:border-emerald-500 focus:ring-emerald-500 w-full bg-white hover:bg-slate-50 transition-all duration-200 text-left">
                                <div className="flex items-center gap-3 w-full">
                                  ...
                                  <SelectValue
                                    ...
                                    className="flex-1 text-left text-slate-600"
                                  >
                                    {field.value === "admin" && (
                            ...
                            <SelectContent className="border-slate-200 bg-white shadow-xl rounded-lg max-h-[300px] overflow-y-auto z-50">
                              <SelectItem
                                value="admin"
                                className="py-3 px-4 hover:bg-emerald-50 focus:bg-emerald-50 cursor-pointer data-[state=checked]:bg-emerald-50 data-[state=checked]:text-emerald-700"
                              >
