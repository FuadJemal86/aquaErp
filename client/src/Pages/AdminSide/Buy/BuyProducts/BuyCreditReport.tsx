            ...
            <div className="mt-3">
              ...
              {detailLoading ? (
                ...
                <div className="space-y-6">
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Buy Credit Summary</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Badge variant={getStatusBadgeVariant(selectedCredit.status)}>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        {creditDetails.length} item(s) in this buy credit transaction
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="rounded-md border">
