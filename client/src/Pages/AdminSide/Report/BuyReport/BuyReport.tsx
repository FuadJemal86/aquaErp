...
function BuyReport() {
    ...
    const getTotalPurchases = () => {
        return summaryData.reduce((total, purchase) => {
            return total + calculateTotal(purchase.price_per_quantity, purchase.quantity);
        }, 0);
    };
    ...
    const getTotalQuantity = () => {
        return summaryData.reduce((total, purchase) => total + purchase.quantity, 0);
    };
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {getTotalTransactions() > 0
                                ? (getTotalPurchases() / getTotalTransactions()).toLocaleString()
                                : "0"} Birr
                        </div>
