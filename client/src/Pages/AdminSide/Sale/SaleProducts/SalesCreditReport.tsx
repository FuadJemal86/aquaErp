...
const SalesCreditReport: React.FC = () => {
    ...
    // Fetch sales credit report with pagination and filtering
    const fetchSalesCredits = async () => {
        try {
            ...
            if (debouncedFilters.customerName) params.customerName = debouncedFilters.customerName;
            ...
            const response = await api.get("/admin/get-all-sales-credits", { params });
    ...
    // Handle view details
    const handleViewDetails = (credit: SalesCredit) => {
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                        ...
                        <CardDescription>
                            Manage and track sales credit transactions
                        </CardDescription>
                        ...
                        <div className="mt-3">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-lg font-medium text-card-foreground">
                                    Sales Credit Details - {selectedCredit.transaction_id}
                                </h3>
                                <button
                            ...
                            <div className="max-h-[80vh] overflow-y-auto">
                                {detailLoading ? (
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <Card>
                                            <CardHeader>
                                                <CardTitle className="text-lg">Sales Credit Summary</CardTitle>
                                            </CardHeader>
                                            <CardContent>
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div className="space-y-2">
                                        ...
                                        <Card>
                                            <CardHeader>
                                                ...
                                                <CardDescription>
                                                    {creditDetails.length} item(s) in this sales credit
                                                    transaction
                                                </CardDescription>
                                            </CardHeader>
                                            <CardContent>
                                                        ...
                                                        <TableBody>
                                                            {creditDetails.map((detail) => (
                                                                <TableRow key={detail.id}>
                                                                    ...
                                                                    <TableCell className="font-semibold">
                                                                        {formatCurrency(detail.price_per_quantity * detail.quantity)}
                                                                    </TableCell>
                                                                    <TableCell>
...
export default SalesCreditReport;